    ...
    <div class="modal-content">
     ...
     <form class="form-horizontal">
      ...
      <div class="control-group">
        ...
        <div class="controls">
         <div class="col-md-12">
          <input name="nama_sales_tambah" id="nama_sales_tambah" class="form-control" type="text" placeholder="Nama Sales"  required>
        </div>
      </div>
    </div>
    <div class="control-group">
...
<div class="modal-footer">
  <button class="btn" data-dismiss="modal" aria-hidden="true">Tutup</button>
  <button class="btn btn-info" id="btn_simpan_sales">Simpan</button>
</div>
</form>
</div>
</div>
...
<div class="modal fade" id="Modal_Edit_Sales" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <form class="form-horizontal">
      <div class="modal-body">
        <input type="text" name="id_sales_edit" id="id_sales_edit" class="form-control"  required="true" hidden> 
        <input name="id_supplier_sales_edit" id="id_supplier_sales_edit" class="form-control" type="text" hidden>
        <div class="form-group">
          <label class="control-label col-xs-3" >Supplier</label>
          <div class="col-md-12">
...
<div class="modal fade" id="Modal_Edit_Supplier" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
     ...
     <form class="form-horizontal">
      <div class="modal-body">
        <input type="text" name="id_supplier_edit" id="id_supplier_edit" class="form-control"  required="true" hidden> 
        <div class="form-group">
          <label class="control-label col-xs-3" >Supplier</label>
          <div class="col-md-12">
