        ...
        function show_product(){
          $.ajax({
            ...
            success : function(data){
              ...
              $('#show_data').html(html);
              $('#total_beli').html(convertToRupiah(totalhpp));
            }
...
<!--   <script type="text/javascript">
    $('#harga_edit,#disc_1_edit,#disc_2_edit,#disc_3_edit,#hpp_edit').on('keydown change keyup paste blur keyup',function(){
     var disc_1_edit = $('#disc_1_edit').val();
     var disc_2_edit = $('#disc_2_edit').val();
     var disc_3_edit = $('#disc_3_edit').val();
     var harga_edit = $('#harga_edit').val();
     ...
     if(harga_edit !=''){
      $.ajax({
        url: "<?php echo base_url(); ?>admin/hpp_akhir",
        method: "POST",
        data: {disc_1_edit:disc_1_edit, disc_2_edit:disc_2_edit, disc_3_edit:disc_3_edit, harga_edit:harga_edit, hpp_edit:hpp_edit},
        success: function(data){

          $('#hpp_edit').val(hpp_edit);

            // $('[name="hpp_edit"]').html(data);
          }
        });
    }
  });
