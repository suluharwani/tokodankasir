            ...
            <div class="box">
              <div class="box-header">
                <div class="row form-inline">
                  <div>
                   <div class="pull-right"><a class="btn btn-sm btn-success" data-toggle="modal" id=""><span class="fa fa-plus"></span>(F8) Tambah Pembelian</a></div>
  ...
  document.onkeyup = function(e) {
    if (e.which == 119) {
      ...
      $.ajax({
        ...
        method: "POST",
        data: {nomor_faktur_input:faktur_penjualan, id_admin:id_admin},
        success: function(data){
