<script src="<?=base_url('assets/')?>/jscode/jquery-1.11.1.min.js"></script>
<link href="<?=base_url('assets/')?>/bootstrap-3.3.7/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
